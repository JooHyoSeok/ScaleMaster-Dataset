...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{
\LARGE \bf Have We Mastered Scale in Deep Monocular Visual SLAM? \\ The ScaleMaster Dataset and Benchmark
}

\author{Hyoseok Ju$^{1}$, Bokeon Suh$^{1}$, and Giseop Kim$^{1*}$%
\thanks{$^{1}$H. Ju, B. Suh, and G. Kim are with the Department of Robotics and Mechatronics Engineering, DGIST, Daegu, Republic of Korea {\tt\small [hyoseok.ju, bokeon.suh, gsk]@dgist.ac.kr}}%
}
...
\input{src/problem_definition}
\input{src/dataset_v2}
\input{src/Experimental_Evaluation}
